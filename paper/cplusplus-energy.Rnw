...
for (i in rownames(pccito.std.noinit) ) {
  ...
  row.summary <- pccito.std.summary[ pccito.std.summary$work == row$work & pccito.std.summary$compiler == row$compiler & pccito.std.summary$opt == row$opt & pccito.std.summary$program == row$program & pccito.std.summary$length == row$length & pccito.std.summary$std == row$std,]

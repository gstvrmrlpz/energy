...
The experiments were run on a PC with AMD Ryzen 7 3700X processor, 32GiB of DDR4 memory and 500GiB KINGSTON SA2000M8500G NVMe drive. The operating system is Fedora Linux 40 Workstation Edition. The compilers used are clang++ version 18.1.6 and g++ versión 14.1.1 20240701.
